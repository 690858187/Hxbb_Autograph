...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of Hxbb_Autograph.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/690858187@qq.com/Hxbb_Autograph'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '690858187@qq.com' => '690858187@qq.com' }
  s.source           = { :git => 'https://github.com/690858187@qq.com/Hxbb_Autograph.git', :tag => s.version.to_s }
